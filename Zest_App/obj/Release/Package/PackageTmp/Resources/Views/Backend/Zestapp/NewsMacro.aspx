<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/backend.Master" AutoEventWireup="true" CodeBehind="NewsMacro.aspx.cs" Inherits="Zest_App.Resources.Views.Backend.Zestapp.NewsMacro" %>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-control">
                                                    <asp:ListItem Value="MERCADO" Text="MACRO"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
