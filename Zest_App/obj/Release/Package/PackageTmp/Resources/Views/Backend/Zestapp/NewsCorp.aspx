<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/backend.Master" AutoEventWireup="true" CodeBehind="NewsCorp.aspx.cs" Inherits="Zest_App.Resources.Views.Backend.Zestapp.NewsCorp" %>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-2">
                                                                <asp:Image ID="Image1" ImageUrl='<%# Eval("url_img") %>' runat="server" Style="width: 100%;background:#d3d3d3" CssClass="same-height" />
                                                            </div>
                                                            <div class="col-10">
                                                                <b><%# Eval("titular") %></b><br />
                                                                <p>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-control">
                                                    <asp:ListItem Value="CORP"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
