<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/auth.Master" AutoEventWireup="true" CodeBehind="Phone.aspx.cs" Inherits="Zest_App.Resources.Views.Auth.Phone" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
     <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            ...
            <div class="top_input">
                <asp:TextBox ID="txtPIN" CssClass="form-control" runat="server" placeholder="999 999 999" ReadOnly="true"></asp:TextBox>
       ...
       <script>
        function pad_number(e) {
            ...
            if (e == 'd') {
                ...
                if ($('#content_txtPIN').val().length >= 15) {
                    return false;
                }
        ...
        function pin_validate() {
            if ($('#content_txtPIN').val().length < 9) {
                return false;
            }
        }
       </script>
