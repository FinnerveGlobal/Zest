<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/app.Master" AutoEventWireup="true" CodeBehind="NewsMercado.aspx.cs" Inherits="Zest_App.Resources.Views.News.NewsMercado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="notas_menu" >
        <a class="menu_item btn_load active" href="NewsMercado.aspx">Macro
             <span></span>
        </a>
        
        <a id="next_item btn_load" class="menu_item " href="NewsCorp.aspx">Compañias
             <span></span>
        </a>
        <a class="menu_item btn_load" href="NewsZest.aspx">Blog
             <span></span>
        </a>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    <script>
        ...
        $('.container').on('swipeleft', function (e, data) {
            $('#next_item').trigger();
        });
