<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/backend.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Team.aspx.cs" Inherits="Zest_App.Resources.Views.Backend.Zestweb.Aboutus.Team" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="dgvTable" runat="server" CssClass="table table-hover table-pagination dataTable" AutoGenerateColumns="false" OnPageIndexChanging="dgvTable_PageIndexChanging" AllowPaging="true" PageSize="50"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                 <img alt="image" src='<%# Eval("url_img") %>' class="rounded-circle" width="35">
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nuevo miembro del equipo</h5>
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-md-12">
                                      ...
                                      <div class="form-group">
                                                <label>Cargo</label>
                                                <asp:TextBox ID="txtCargoEdit" runat="server" CssClass="form-control" ></asp:TextBox>
                                      </div>
                                     <div class="form-group">
                                                <label>Linkedin</label>
                                                <asp:TextBox ID="txtLinkedinEdit" runat="server" CssClass="form-control"></asp:TextBox>
                                      </div>
                                    <div class="form-group">
