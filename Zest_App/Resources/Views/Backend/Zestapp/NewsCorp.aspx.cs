    ...
    public partial class NewsCorp : System.Web.UI.Page
    {
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            using (var ctx = new zestapp_dbEntities())
            {
                ...
                txtFechaEdit.Text = item.updated_at.Value.ToString("yyyy-MM-dd");
        ...
        protected void btnPublicar_Click(object sender, EventArgs e)
        {
            using (var ctx = new zestapp_dbEntities())
            {
                ...
                ctx.SaveChanges();
                loadData();
                //SendNotification.send("Noticias Zest", "Revisa las noticias más relevantes de los subyacentes de tu nota");
