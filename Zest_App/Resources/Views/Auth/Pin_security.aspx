<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Layout/auth.Master" AutoEventWireup="true" CodeBehind="Pin_security.aspx.cs" Inherits="Zest_App.Resources.Views.Auth.Pin_security" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            ...
            <div class="top_input">
                <label>Ingrese una <br /> <span style="color:#ffd800"> nueva clave
                                         </span> de seguridad</label>
